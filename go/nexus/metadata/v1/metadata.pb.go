...
type Column struct {
	...
	Type          ColumnType             `protobuf:"varint,3,opt,name=type,proto3,enum=metadata.v1.ColumnType" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Compaction struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CreatedAt     *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	Level         CompactionLevel        `protobuf:"varint,2,opt,name=level,proto3,enum=metadata.v1.CompactionLevel" json:"level,omitempty"`
...
type Value struct {
	...
	Comp          Compression            `protobuf:"varint,3,opt,name=comp,proto3,enum=metadata.v1.Compression" json:"comp,omitempty"`
...
const file_nexus_metadata_v1_metadata_proto_rawDesc = "" +
	"\n" +
	" nexus/metadata/v1/metadata.proto\x12\vmetadata.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"%\n" +
	...
	"\x12partition_metadata\x18\x02 \x01(\v2\x1e.metadata.v1.PartitionMetadataR\x11partitionMetadata\"\xa3\x01\n" +
	"\x17CreatePartitionResponse\x129\n" +
	"\n" +
	"created_at\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12M\n" +
	"\x12partition_metadata\x18\x02 \x01(\v2\x1e.metadata.v1.PartitionMetadataR\x11partitionMetadata\"\xcd\x01\n" +
	...
	"\bversions\x18\x02 \x03(\fR\bversions\"\xd9\x01\n" +
	"\x16ListPartitionsResponse\x129\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bend_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\x12M\n" +
	"\x12partition_metadata\x18\x03 \x03(\v2\x1e.metadata.v1.PartitionMetadataR\x11partitionMetadata\"S\n" +
	"\x1eValidateMetadataVersionRequest\x121\n" +
	"\bversions\x18\x01 \x03(\v2\x15.metadata.v1.ValidateR\bversions\"7\n" +
	...
	"\aversion\x18\x02 \x01(\fR\aversion\"\xfd\x02\n" +
	"\x11PartitionMetadata\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x128\n" +
	"\vcluster_key\x18\x02 \x01(\v2\x17.metadata.v1.ClusterKeyR\n" +
	"clusterKey\x12\x1a\n" +
	...
	"\acolumns\x18\a \x03(\v2+.metadata.v1.PartitionMetadata.ColumnsEntryR\acolumns\x1aO\n" +
	"\fColumnsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.metadata.v1.ColumnR\x05value:\x028\x01\"\x82\x01\n" +
	"\x06Column\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x127\n" +
	"\n" +
	"statistics\x18\x02 \x01(\v2\x17.metadata.v1.StatisticsR\n" +
	"statistics\x12+\n" +
	"\x04type\x18\x03 \x01(\x0e2\x17.metadata.v1.ColumnTypeR\x04type\"\xf2\x04\n" +
	"\n" +
	"Statistics\x12\x1d\n" +
	...
	"\tdevice_id\x18\x02 \x01(\x04R\bdeviceId\"\xbc\x01\n" +
	"\n" +
	"Compaction\x129\n" +
	"\n" +
	"created_at\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x122\n" +
	"\x05level\x18\x02 \x01(\x0e2\x1c.metadata.v1.CompactionLevelR\x05level\x12+\n" +
	"\x06window\x18\x03 \x01(\v2\x13.metadata.v1.WindowR\x06window\x12\x12\n" +
	"\x04size\x18\x04 \x01(\x04R\x04size\"\x8e\x01\n" +
	"\x06Window\x12\x12\n" +
	"\x04size\x18\x01 \x01(\rR\x04size\x129\n" +
	"\n" +
	"start_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tstartTime\x125\n" +
	"\bend_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\aendTime\"\xbd\x01\n" +
	"\x05Value\x129\n" +
	"\n" +
	"created_at\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\x12,\n" +
	"\x04comp\x18\x03 \x01(\x0e2\x18.metadata.v1.CompressionR\x04comp\x12\x10\n" +
	...
	"\x12COMPRESSION_SNAPPY\x10\x032\xcc\x05\n" +
	"\x0fMetadataService\x12U\n" +
	"\fCreateTenant\x12 .metadata.v1.CreateTenantRequest\x1a!.metadata.v1.CreateTenantResponse\"\x00\x12U\n" +
	"\fDeleteTenant\x12 .metadata.v1.DeleteTenantRequest\x1a!.metadata.v1.DeleteTenantResponse\"\x00\x12^\n" +
	"\x0fCreatePartition\x12#.metadata.v1.CreatePartitionRequest\x1a$.metadata.v1.CreatePartitionResponse\"\x00\x12[\n" +
	"\x0eListPartitions\x12\".metadata.v1.ListPartitionsRequest\x1a#.metadata.v1.ListPartitionsResponse\"\x00\x12v\n" +
	"\x17ValidateMetadataVersion\x12+.metadata.v1.ValidateMetadataVersionRequest\x1a,.metadata.v1.ValidateMetadataVersionResponse\"\x00\x12g\n" +
	"\x12GetMetadataVersion\x12&.metadata.v1.GetMetadataVersionRequest\x1a'.metadata.v1.GetMetadataVersionResponse\"\x00\x12m\n" +
	"\x14ListMetadataVersions\x12(.metadata.v1.ListMetadataVersionsRequest\x1a).metadata.v1.ListMetadataVersionsResponse\"\x00B>Z<github.com/liquidspill/proto/go/nexus/metadata/v1;metadatav1b\x06proto3"
...
var file_nexus_metadata_v1_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_nexus_metadata_v1_metadata_proto_goTypes = []any{
	(ColumnType)(0),                         // 0: metadata.v1.ColumnType
	(CompactionLevel)(0),                    // 1: metadata.v1.CompactionLevel
	(Compression)(0),                        // 2: metadata.v1.Compression
	(*CreateTenantRequest)(nil),             // 3: metadata.v1.CreateTenantRequest
	(*CreateTenantResponse)(nil),            // 4: metadata.v1.CreateTenantResponse
	(*DeleteTenantRequest)(nil),             // 5: metadata.v1.DeleteTenantRequest
	(*DeleteTenantResponse)(nil),            // 6: metadata.v1.DeleteTenantResponse
	(*CreatePartitionRequest)(nil),          // 7: metadata.v1.CreatePartitionRequest
	(*CreatePartitionResponse)(nil),         // 8: metadata.v1.CreatePartitionResponse
	(*ListPartitionsRequest)(nil),           // 9: metadata.v1.ListPartitionsRequest
	(*GetMetadataVersionRequest)(nil),       // 10: metadata.v1.GetMetadataVersionRequest
	(*GetMetadataVersionResponse)(nil),      // 11: metadata.v1.GetMetadataVersionResponse
	(*ListMetadataVersionsRequest)(nil),     // 12: metadata.v1.ListMetadataVersionsRequest
	(*ListMetadataVersionsResponse)(nil),    // 13: metadata.v1.ListMetadataVersionsResponse
	(*ListPartitionsResponse)(nil),          // 14: metadata.v1.ListPartitionsResponse
	(*ValidateMetadataVersionRequest)(nil),  // 15: metadata.v1.ValidateMetadataVersionRequest
	(*ValidateMetadataVersionResponse)(nil), // 16: metadata.v1.ValidateMetadataVersionResponse
	(*Validate)(nil),                        // 17: metadata.v1.Validate
	(*PartitionMetadata)(nil),               // 18: metadata.v1.PartitionMetadata
	(*Column)(nil),                          // 19: metadata.v1.Column
	(*Statistics)(nil),                      // 20: metadata.v1.Statistics
	(*ClusterKey)(nil),                      // 21: metadata.v1.ClusterKey
	(*Compaction)(nil),                      // 22: metadata.v1.Compaction
	(*Window)(nil),                          // 23: metadata.v1.Window
	(*Value)(nil),                           // 24: metadata.v1.Value
	(*Variant)(nil),                         // 25: metadata.v1.Variant
	nil,                                     // 26: metadata.v1.PartitionMetadata.ColumnsEntry
	(*timestamppb.Timestamp)(nil),           // 27: google.protobuf.Timestamp
}
var file_nexus_metadata_v1_metadata_proto_depIdxs = []int32{
	27, // 0: metadata.v1.CreateTenantResponse.created_at:type_name -> google.protobuf.Timestamp
	27, // 1: metadata.v1.DeleteTenantResponse.deleted_at:type_name -> google.protobuf.Timestamp
	18, // 2: metadata.v1.CreatePartitionRequest.partition_metadata:type_name -> metadata.v1.PartitionMetadata
	27, // 3: metadata.v1.CreatePartitionResponse.created_at:type_name -> google.protobuf.Timestamp
	18, // 4: metadata.v1.CreatePartitionResponse.partition_metadata:type_name -> metadata.v1.PartitionMetadata
	27, // 5: metadata.v1.ListPartitionsRequest.start_time:type_name -> google.protobuf.Timestamp
	27, // 6: metadata.v1.ListPartitionsRequest.end_time:type_name -> google.protobuf.Timestamp
	27, // 7: metadata.v1.GetMetadataVersionRequest.window:type_name -> google.protobuf.Timestamp
	27, // 8: metadata.v1.ListMetadataVersionsRequest.window_start:type_name -> google.protobuf.Timestamp
	27, // 9: metadata.v1.ListMetadataVersionsRequest.window_end:type_name -> google.protobuf.Timestamp
	27, // 10: metadata.v1.ListMetadataVersionsResponse.windows:type_name -> google.protobuf.Timestamp
	27, // 11: metadata.v1.ListPartitionsResponse.start_time:type_name -> google.protobuf.Timestamp
	27, // 12: metadata.v1.ListPartitionsResponse.end_time:type_name -> google.protobuf.Timestamp
	18, // 13: metadata.v1.ListPartitionsResponse.partition_metadata:type_name -> metadata.v1.PartitionMetadata
	17, // 14: metadata.v1.ValidateMetadataVersionRequest.versions:type_name -> metadata.v1.Validate
	27, // 15: metadata.v1.Validate.window:type_name -> google.protobuf.Timestamp
	21, // 16: metadata.v1.PartitionMetadata.cluster_key:type_name -> metadata.v1.ClusterKey
	27, // 17: metadata.v1.PartitionMetadata.created_at:type_name -> google.protobuf.Timestamp
	26, // 18: metadata.v1.PartitionMetadata.columns:type_name -> metadata.v1.PartitionMetadata.ColumnsEntry
	20, // 19: metadata.v1.Column.statistics:type_name -> metadata.v1.Statistics
	0,  // 20: metadata.v1.Column.type:type_name -> metadata.v1.ColumnType
	27, // 21: metadata.v1.Statistics.min_timestamp:type_name -> google.protobuf.Timestamp
	27, // 22: metadata.v1.Statistics.max_timestamp:type_name -> google.protobuf.Timestamp
	27, // 23: metadata.v1.ClusterKey.timestamp:type_name -> google.protobuf.Timestamp
	27, // 24: metadata.v1.Compaction.created_at:type_name -> google.protobuf.Timestamp
	1,  // 25: metadata.v1.Compaction.level:type_name -> metadata.v1.CompactionLevel
	23, // 26: metadata.v1.Compaction.window:type_name -> metadata.v1.Window
	27, // 27: metadata.v1.Window.start_time:type_name -> google.protobuf.Timestamp
	27, // 28: metadata.v1.Window.end_time:type_name -> google.protobuf.Timestamp
	27, // 29: metadata.v1.Value.created_at:type_name -> google.protobuf.Timestamp
	27, // 30: metadata.v1.Value.updated_at:type_name -> google.protobuf.Timestamp
	2,  // 31: metadata.v1.Value.comp:type_name -> metadata.v1.Compression
	27, // 32: metadata.v1.Variant.timestamp_variant:type_name -> google.protobuf.Timestamp
	19, // 33: metadata.v1.PartitionMetadata.ColumnsEntry.value:type_name -> metadata.v1.Column
	3,  // 34: metadata.v1.MetadataService.CreateTenant:input_type -> metadata.v1.CreateTenantRequest
	5,  // 35: metadata.v1.MetadataService.DeleteTenant:input_type -> metadata.v1.DeleteTenantRequest
	7,  // 36: metadata.v1.MetadataService.CreatePartition:input_type -> metadata.v1.CreatePartitionRequest
	9,  // 37: metadata.v1.MetadataService.ListPartitions:input_type -> metadata.v1.ListPartitionsRequest
	15, // 38: metadata.v1.MetadataService.ValidateMetadataVersion:input_type -> metadata.v1.ValidateMetadataVersionRequest
	10, // 39: metadata.v1.MetadataService.GetMetadataVersion:input_type -> metadata.v1.GetMetadataVersionRequest
	12, // 40: metadata.v1.MetadataService.ListMetadataVersions:input_type -> metadata.v1.ListMetadataVersionsRequest
	4,  // 41: metadata.v1.MetadataService.CreateTenant:output_type -> metadata.v1.CreateTenantResponse
	6,  // 42: metadata.v1.MetadataService.DeleteTenant:output_type -> metadata.v1.DeleteTenantResponse
	8,  // 43: metadata.v1.MetadataService.CreatePartition:output_type -> metadata.v1.CreatePartitionResponse
	14, // 44: metadata.v1.MetadataService.ListPartitions:output_type -> metadata.v1.ListPartitionsResponse
	16, // 45: metadata.v1.MetadataService.ValidateMetadataVersion:output_type -> metadata.v1.ValidateMetadataVersionResponse
	11, // 46: metadata.v1.MetadataService.GetMetadataVersion:output_type -> metadata.v1.GetMetadataVersionResponse
	13, // 47: metadata.v1.MetadataService.ListMetadataVersions:output_type -> metadata.v1.ListMetadataVersionsResponse
...
func file_nexus_metadata_v1_metadata_proto_init() {
	...
	file_nexus_metadata_v1_metadata_proto_msgTypes[17].OneofWrappers = []any{
	...
	file_nexus_metadata_v1_metadata_proto_msgTypes[22].OneofWrappers = []any{

...
func (x *CreateManifestRequest) GetTeamPid() string {
	if x != nil {
		return x.TeamPid
	}
	return ""
...
func (x *CreateManifestResponse) GetTeamPid() string {
	if x != nil {
		return x.TeamPid
	}
	return ""
...
const file_nexus_catalog_v1_catalog_proto_rawDesc = "" +
	"\n" +
	"\x1enexus/catalog/v1/catalog.proto\x12\x10nexus.catalog.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8b\x01\n" +
	"\x15CreateManifestRequest\x12\x19\n" +
	"\bteam_pid\x18\x01 \x01(\tR\ateamPid\x12\x1f\n" +
	"\vdataset_pid\x18\x02 \x01(\tR\n" +
	"datasetPid\x126\n" +
	"\bmanifest\x18\x03 \x01(\v2\x1a.nexus.catalog.v1.ManifestR\bmanifest\"\xd9\x01\n" +
	...
	"datasetPid\x126\n" +
	"\bmanifest\x18\x04 \x01(\v2\x1a.nexus.catalog.v1.ManifestR\bmanifest\x129\n" +
	"\n" +

...
type HeartbeatRequest_Collector struct {
	Collector *CollectorMetadata `protobuf:"bytes,2,opt,name=collector,proto3,oneof"`
}

type HeartbeatRequest_Tap struct {
	Tap *TapMetadata `protobuf:"bytes,3,opt,name=tap,proto3,oneof"`
}
...
const file_nexus_controlplane_v1_control_plane_proto_rawDesc = "" +
	...
	"\x04rows\x18\x02 \x03(\v2\x1a.nexus.controlplane.v1.RowR\x04rows\"\xb0\x01\n" +
	"\x10HeartbeatRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12H\n" +
	"\tcollector\x18\x02 \x01(\v2(.nexus.controlplane.v1.CollectorMetadataH\x00R\tcollector\x126\n" +
	"\x03tap\x18\x03 \x01(\v2\".nexus.controlplane.v1.TapMetadataH\x00R\x03tapB\n" +
	"\n" +
	"\bmetadata\"#\n" +

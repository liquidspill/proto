...
func (x *SeriesData) GetValues() []*Value {
	if x != nil {
		return x.Values
	}
	return nil
...
const file_scour_v1_scour_proto_rawDesc = "" +
	"\n" +
	"\x14scour/v1/scour.proto\x12\bscour.v1\x1a\x1fgoogle/protobuf/timestamp.proto\";\n" +
	...
	"\x06values\x18\x02 \x03(\v2\x0f.scour.v1.ValueR\x06values\"C\n" +
	"\x06Result\x12\x16\n" +
	"\x06fields\x18\x01 \x03(\tR\x06fields\x12!\n" +
	"\x04rows\x18\x02 \x03(\v2\r.scour.v1.RowR\x04rows\".\n" +
	"\x03Row\x12'\n" +
	"\x06values\x18\x01 \x03(\v2\x0f.scour.v1.ValueR\x06values\"\xcf\x02\n" +
	"\x05Value\x12!\n" +
	...
	"\x13SORT_ORDER_UNSIGNED\x10\x03B2Z0github.com/liquidspill/proto/go/scour/v1;scourv1b\x06proto3"
...
var file_scour_v1_scour_proto_depIdxs = []int32{
	...
	19, // 21: scour.v1.FileMetadata.schema_descriptor:type_name -> scour.v1.Thrift

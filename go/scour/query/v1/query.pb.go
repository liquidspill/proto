...
const file_scour_query_v1_query_proto_rawDesc = "" +
	"\n" +
	"\x1ascour/query/v1/query.proto\x12\bscour.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x10std/v1/std.proto\";\n" +
	"\x12CreateQueryRequest\x12%\n" +
	"\x05query\x18\x01 \x01(\v2\x0f.scour.v1.QueryR\x05query\"y\n" +
	"\x13CreateQueryResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12(\n" +
	"\x06series\x18\x02 \x01(\v2\x10.scour.v1.SeriesR\x06series\x12(\n" +
	"\x06result\x18\x03 \x01(\v2\x10.scour.v1.ResultR\x06result\"\xa2\x02\n" +
	"\x05Query\x121\n" +
	"\tvisualise\x18\x01 \x03(\v2\x13.scour.v1.VisualiseR\tvisualise\x12%\n" +
	"\x05where\x18\x02 \x01(\v2\x0f.scour.v1.WhereR\x05where\x12\x19\n" +
	"\bgroup_by\x18\x03 \x03(\tR\agroupBy\x12*\n" +
	"\border_by\x18\x04 \x03(\v2\x0f.scour.v1.OrderR\aorderBy\x12\x14\n" +
	"\x05limit\x18\x05 \x01(\rR\x05limit\x12(\n" +
	"\x06having\x18\x06 \x01(\v2\x10.scour.v1.ClauseR\x06having\x12\x1d\n" +
	"\n" +
	"start_time\x18\a \x01(\x03R\tstartTime\x12\x19\n" +
	"\bend_time\x18\b \x01(\x03R\aendTime\"H\n" +
	"\tVisualise\x12%\n" +
	"\x02op\x18\x01 \x01(\x0e2\x15.scour.v1.VisualiseOpR\x02op\x12\x14\n" +
	"\x05field\x18\x02 \x01(\tR\x05field\"V\n" +
	"\x05Where\x12!\n" +
	"\x02op\x18\x01 \x01(\x0e2\x11.scour.v1.WhereOpR\x02op\x12*\n" +
	"\aclauses\x18\x02 \x03(\v2\x10.scour.v1.ClauseR\aclauses\"Y\n" +
	"\x06Clause\x12\x14\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x14.scour.v1.SeriesDataR\x05value:\x028\x01\"G\n" +
	"\n" +
	"SeriesData\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12%\n" +
	"\x06values\x18\x02 \x03(\v2\r.std.v1.ValueR\x06values\"C\n" +
	"\x06Result\x12\x16\n" +
	"\x06fields\x18\x01 \x03(\tR\x06fields\x12!\n" +
	"\x04rows\x18\x02 \x03(\v2\r.scour.v1.RowR\x04rows\",\n" +
	"\x03Row\x12%\n" +
	"\x06values\x18\x01 \x03(\v2\r.std.v1.ValueR\x06values\"\x7f\n" +
	"\x0fParquetMetadata\x12;\n" +
	"\rfile_metadata\x18\x01 \x01(\v2\x16.scour.v1.FileMetadataR\ffileMetadata\x12/\n" +
	"\n" +
	"row_groups\x18\x02 \x03(\v2\x10.scour.v1.ThriftR\trowGroups\"\x1e\n" +
	"\x06Thrift\x12\x14\n" +
	"\x05bytes\x18\x01 \x01(\fR\x05bytes\"\xb3\x02\n" +
	"\fFileMetadata\x12\x18\n" +
	"\aversion\x18\x01 \x01(\x05R\aversion\x12\x19\n" +
	"\bnum_rows\x18\x02 \x01(\x03R\anumRows\x12\"\n" +
	"\n" +
	"created_by\x18\x03 \x01(\tH\x00R\tcreatedBy\x88\x01\x01\x12@\n" +
	"\x12key_value_metadata\x18\x04 \x03(\v2\x12.scour.v1.KeyValueR\x10keyValueMetadata\x12=\n" +
	"\x11schema_descriptor\x18\x05 \x03(\v2\x10.scour.v1.ThriftR\x10schemaDescriptor\x12:\n" +
	"\rcolumn_orders\x18\x06 \x03(\v2\x15.scour.v1.ColumnOrderR\fcolumnOrdersB\r\n" +
	"\v_created_by\"A\n" +
	"\bKeyValue\x12\x10\n" +
	...
	"\x06_value\"j\n" +
	"\vColumnOrder\x12'\n" +
	"\x04type\x18\x01 \x01(\x0e2\x13.scour.v1.OrderTypeR\x04type\x122\n" +
	"\n" +
	"sort_order\x18\x02 \x01(\x0e2\x13.scour.v1.SortOrderR\tsortOrder*\x81\x04\n" +
...
var file_scour_query_v1_query_proto_goTypes = []any{
	...
	(*ParquetMetadata)(nil),       // 17: scour.v1.ParquetMetadata
	(*Thrift)(nil),                // 18: scour.v1.Thrift
	(*FileMetadata)(nil),          // 19: scour.v1.FileMetadata
	(*KeyValue)(nil),              // 20: scour.v1.KeyValue
	(*ColumnOrder)(nil),           // 21: scour.v1.ColumnOrder
	nil,                           // 22: scour.v1.Series.DataEntry
...
var file_scour_query_v1_query_proto_depIdxs = []int32{
	...
	22, // 13: scour.v1.Series.data:type_name -> scour.v1.Series.DataEntry
	24, // 14: scour.v1.SeriesData.values:type_name -> std.v1.Value
	16, // 15: scour.v1.Result.rows:type_name -> scour.v1.Row
	24, // 16: scour.v1.Row.values:type_name -> std.v1.Value
	19, // 17: scour.v1.ParquetMetadata.file_metadata:type_name -> scour.v1.FileMetadata
	18, // 18: scour.v1.ParquetMetadata.row_groups:type_name -> scour.v1.Thrift
	20, // 19: scour.v1.FileMetadata.key_value_metadata:type_name -> scour.v1.KeyValue
	18, // 20: scour.v1.FileMetadata.schema_descriptor:type_name -> scour.v1.Thrift
	21, // 21: scour.v1.FileMetadata.column_orders:type_name -> scour.v1.ColumnOrder
	...
	14, // 24: scour.v1.Series.DataEntry.value:type_name -> scour.v1.SeriesData

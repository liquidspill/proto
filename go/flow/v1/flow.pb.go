...
const file_flow_v1_flow_proto_rawDesc = "" +
	"\n" +
	"\x12flow/v1/flow.proto\x12\aflow.v1\x1a\x13tagger/tagger.proto\"\xeb%\n" +
	"\x04Flow\x12U\n" +
	"\rfluid_version\x18\x01 \x01(\tB0\x9a\x84\x9e\x03+parquet:\"fluid_version,dict\" fluid:\"minmax\"R\ffluidVersion\x12R\n" +
	"\x04type\x18\x02 \x01(\x0e2\x16.flow.v1.Flow.FlowTypeB&\x9a\x84\x9e\x03!parquet:\"type,dict\" fluid:\"bloom\"R\x04type\x12`\n" +
	...
	"\x0fFLOW_TYPE_IPFIX\x10\x04B0Z.github.com/liquidspill/proto/go/flow/v1;flowv1b\x06proto3"
